...
namespace SoftwareLocker
{
    ...
    public class TrialMaker
    {
        ...
        private void SetDefaults()
        {
            ...
            string sd = SystemInfo.UseBaseBoardProduct.ToString();
        ...
        {
            _BaseString = Encryption.Boring(Encryption.InverseByBase(SystemInfo.GetSystemInfo(""), 10));
        }
